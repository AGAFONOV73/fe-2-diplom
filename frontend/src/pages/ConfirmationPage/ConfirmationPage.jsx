          ...
          <div className="confirmation-main">
            {!isConfirmed ? (
              ...
              <div className="order-details">
                ...
                <div className="details-grid">
                  {passengers.map((passenger, index) => (
                    <div className="detail-item" key={`${passenger.id}-${index}`}>
              ...
              <div className="confirmation-card confirmation-card--success">
                ...
                <p className="success-message">
                  №Заказа <strong>{bookingNumber}</strong> <span>сумма {totalPrice.toLocaleString()} ₽</span>
                </p>
                ...
                <div className="success-text">
                  <h2>{passengers[0]?.firstName || "Пассажир"}, ваш заказ успешно оформлен.</h2>
